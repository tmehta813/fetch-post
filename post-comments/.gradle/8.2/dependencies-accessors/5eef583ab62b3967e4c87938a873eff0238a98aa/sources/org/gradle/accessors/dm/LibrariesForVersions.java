 ...
 */
@NonNullApi
public class LibrariesForVersions extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForVersions(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
